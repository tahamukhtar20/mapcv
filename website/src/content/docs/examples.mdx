...
The most common case — download satellite tiles and rasterize KML polygon annotations onto them.
...
This writes `splits/0.05/labeled.txt`, `splits/0.05/unlabeled.txt`, and so on for each ratio.
